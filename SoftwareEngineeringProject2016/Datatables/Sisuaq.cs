...
namespace SoftwareEngineeringProject2016
{
    class Sisuaq
    {
        ...
        public Sisuaq(string fileLocation)
        {
            ...
            Excel.Range c2 = (Excel.Range)xlWorkSheet.Cells[xlWorkSheet.UsedRange.Rows.Count, 15];
        ...
        private void addColumns()
        {
            ...
            dtColumns.Add(new DataColumn("VesselMode"));
            ...
            dtColumns.Add(new DataColumn("TransitAssetTime"));
            dtColumns.Add(new DataColumn("DPCargoOps"));
